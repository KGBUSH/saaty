...
class ETATransporterInfo(Model):
    ...
    transporter_id = db.Column(db.BigInteger, nullable=False)  # 达达ID
...
class ETATransporterPeekDeliveryInfo(Model):
    ...
    per_delivery_time_peek1 = db.Column(db.Integer, nullable=False)             # 统计高峰阶段的中位数时间, 主要是午餐晚餐饭点时间
    per_delivery_time_peek2 = db.Column(db.Integer, nullable=False)             # 统计高峰之间的闲时阶段的中位数时间
    per_delivery_time_peek3 = db.Column(db.Integer, nullable=False)             # 统计半夜到清晨阶段的中位数时间
    per_delivery_time_peek0 = db.Column(db.Integer, nullable=False)             # 统计其他阶段的订单量
