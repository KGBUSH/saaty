...
insert into algo_transporter_delivery_peek_Info 
                                ...
                                %(city_id)s, 
                                %(delivery_cnt)s,
                                %(avg_delivery_time1)s, 
                                %(avg_delivery_time2)s, 
                                %(per_delivery_time1)s, 
                                %(per_delivery_time2)s, 
                                %(cnt_peek1)s, 
                                %(cnt_peek2)s, 
                                %(cnt_peek3)s, 
                                %(cnt_peek0)s,
                                %(per_delivery_time1_peek1)s,
                                %(per_delivery_time1_peek2)s,
                                %(per_delivery_time1_peek3)s,
                                %(per_delivery_time1_peek0)s,
                                %(create_time)s, 
                                %(update_time)s 
                                ) ON duplicate KEY UPDATE  
                                transporter_id = VALUES (transporter_id), 
                                ...
                                avg_delivery_time1 = VALUES  (avg_delivery_time1), 
                                avg_delivery_time2 = VALUES  (avg_delivery_time2), 
                                per_delivery_time1 = VALUES  (per_delivery_time1), 
                                ...
                                per_delivery_time1_peek1 = VALUES (per_delivery_time1_peek1),
                                per_delivery_time1_peek2 = VALUES (per_delivery_time1_peek2),
                                per_delivery_time1_peek3 = VALUES (per_delivery_time1_peek3),
                                per_delivery_time1_peek0 = VALUES (per_delivery_time1_peek0),
                                update_time = VALUES (update_time)
                                '''